...
#define SYS_RM_VERSION         "5.12a"
#define SYS_RM_BUILD           "2014.07.31"
...
// 10 : RSVC_SERV_JOBLOAD           : message     : Opt     :Refer to Below Additional Comment (default DANDY1996)
...
// 61 : RSVC_SRV_WELD_MEASURE_WRITE : message     : Show    : Set      :
// 62 : RSVC_SRV_CAL_WELDCOEFF      : message     : Idx     : ->Use Reply Msg
...
#define     RSVC_SRV_WELD_MEASURE_WRITE  61   // Weld Measurement Value Write
                                              // Value: 0 -> Show, 1 -> Set
#define     RSVC_SRV_CAL_WELDCOEFF       62   // Calculate Weld Coefficient
                                              // Value: Index
...
//
// Message Data Format for Weld Measurement Value Write
#define     MEASURE_WRITE_COUNT             10

#pragma pack(push, 1)
typedef struct t_rmgr_weld_measure_value_write
{
    // weld measurement value
    double  dbControllerCmdVolt[MEASURE_WRITE_COUNT];
    double  dbWelderMeasureVolt[MEASURE_WRITE_COUNT];
    double  dbControllerCmdCurr[MEASURE_WRITE_COUNT];
    double  dbWelderMeasureCurr[MEASURE_WRITE_COUNT];
} RMGR_WELD_MEASURE_VALUE_DATA;
#pragma pack(pop)
...
//
// Message Data Format for Caculated Weld Coefficient
#pragma pack(push, 1)
typedef struct t_rmgr_weld_cal_weldcoeff_data
{
    // calculated weld coefficient value
    double  dbVolt_a;
    double  dbVolt_b;
    double  dbVolt_c;
    double  dbVoltScale;
...
typedef struct t_rmgr_packet
{
    ...
    // For data of MSG 
        ...
        RMGR_WELD_MEASURE_VALUE_DATA  weld_measure;
        RMGR_WELD_CAL_WELDCOEFF_DATA  cal_weldcoeff;
    } Data;
